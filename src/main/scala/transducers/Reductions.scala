...
trait Reductions { this: Transducers =>
  ...
  def buildString[X](s1: String="", s2: String="", s3: String=""): Reducer[X, String] = new Reducer[X, String] {
    ...
    def complete(s: State) = inContext {
      s.builder append s3
      s.builder.toString
    }
  }
